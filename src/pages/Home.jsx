    ...
    <div className="font-sans min-h-screen relative bg-green-100">
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-6xl md:text-7xl font-extrabold text-white mb-6 drop-shadow-lg">AgriAI</h1>
      ...
      <section className="bg-green-900 text-white py-24 px-6 text-center relative overflow-hidden">
        <h2 className="text-4xl md:text-5xl font-bold mb-6">Start Smart Farming Today</h2>
      ...
      <section className="max-w-6xl mx-auto py-20 px-6">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 text-center">
          <div>
            ...
            <p className="text-gray-700 font-medium">Crops Analyzed</p>
          </div>
          <div>
            <h3 className="text-5xl font-bold text-green-700 mb-2">500+</h3>
            <p className="text-gray-700 font-medium">Farmers Helped</p>
          </div>
          <div>
            <h3 className="text-5xl font-bold text-green-700 mb-2">50+</h3>
            <p className="text-gray-700 font-medium">Diseases Detected</p>
          </div>
        </div>
      </section>
